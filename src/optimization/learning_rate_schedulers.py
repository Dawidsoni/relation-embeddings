...
class PiecewiseLinearDecayScheduler(tf.keras.optimizers.schedules.LearningRateSchedule):
    ...
    def __call__(self, step):
        ...
        last_fold_point = 1 + steps_since_warmup // self.decay_steps
        last_fold_learning_rate = self.initial_learning_rate ** last_fold_point
        next_fold_learning_rate = self.initial_learning_rate ** (last_fold_point + 1)
