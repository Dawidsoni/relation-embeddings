...
python3 ../src/train_model.py \
    ...
    --gin_bindings "LossObject.norm_metric_margin = 1.0" \
    ...
    "s_transe/ModelConfig.dropout_rate = 0.5" \
    "ExperimentConfig.experiment_name = 's_transe_fb15k_freeze_5800_margin_1_decay_rate_0_1_dropout_0_5'"
